...
console.log("0. fenomen :", fenomenler[0].profile)


//(2) Dizideki üçüncü fenomenin (2. dizin) takipçi (followers) sayısı
fenomenler[2].followers
console.log("2.index takipçi sayısı :",fenomenler[2].followers )
...
fenomenler[5].profile="Justin Bieber"
console.log("Justin bieber değişiklik:", fenomenler[5])
...
console.log("index'e gore fenomen : ", indekseGoreFenomen(fenomenler,3) )
...
console.log("Profil Liste :", profilListesi(fenomenler))
...
console.log("fenomen sil :",fenomenSil(fenomenler,0))
...
function fenomenEkle(dizi,number,profile,followers,posts,platform) {
  ...
  copyList.push(addList);
  return copyList
}

console.log("fenomen ekle:", fenomenEkle(fenomenler, 6, "Workintech", 10000000, 2022, "Instagram"))
...
function fenomenGonderimSayisi(dizi,profilAdı){
  for (let i=0; i<dizi.length; i++){
    if(dizi[i].profile===profilAdı){
      return dizi[i].posts
    }
...
console.log("Gönderi sayısı :",fenomenGonderimSayisi(fenomenler, 'Will Smith'))
...
function platformaGoreCokGonderiYapanFenomen(dizi,platformAdı){
  ...
  let maxPostSayısı=0;
  let profilName="Bulamadım "

  for (let i=0; i<dizi.length; i++){
    if(dizi[i].platform===platformAdı && dizi[i].posts!=="NA"&& dizi[i].posts > maxPostSayısı){
      maxPostSayısı=dizi[i].posts
      profilName=dizi[i].profile
...
console.log("En çok gönderi yapan:",platformaGoreCokGonderiYapanFenomen(fenomenler, 'TikTok'))
